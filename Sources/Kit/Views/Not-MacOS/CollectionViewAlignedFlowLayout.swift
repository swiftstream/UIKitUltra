...
open class CollectionViewAlignedFlowLayout: CollectionViewFlowLayout {
    ...
    fileprivate var horizontalAlignment: HorizontalAlignment = .justified
    
    @discardableResult
    public func horizontalAlignment(_ value: HorizontalAlignment) -> Self {
    ...
    fileprivate var verticalAlignment: VerticalAlignment = .center
    
    @discardableResult
    public func verticalAlignment(_ value: VerticalAlignment) -> Self {
    ...
    @discardableResult
    public func layoutDirection(_ value: UIUserInterfaceLayoutDirection) -> Self {
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: CollectionViewAlignedFlowLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: CollectionViewAlignedFlowLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: CollectionViewAlignedFlowLayout) {
    ...
    ///
    /// - Parameter collectionViewLayout: The layout on which to perfom the calculations.
    private func alignToFollowingItem(collectionViewLayout: CollectionViewAlignedFlowLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: CollectionViewAlignedFlowLayout) {
    ...
    func alignVertically(collectionViewLayout: CollectionViewAlignedFlowLayout) {
