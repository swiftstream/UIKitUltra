...
final class StateBindingOwnerScaffoldingTests: XCTestCase {
    ...
    func testAttributedStringReusesSlice5CHolder() {
        let attr = UIKitPlus.AttributedString("hello")
        ...
        weak var weakAttr: UIKitPlus.AttributedString?
        weak var weakToken: StateListener?

        autoreleasepool {
            var attr: UIKitPlus.AttributedString? = UIKitPlus.AttributedString("hello")
            weakAttr = attr
