...
12. Prefer the real host toolkit's native layout, sizing, scrolling, animation, diffing/model-view, reuse, input, and lifecycle behavior as the implementation substrate. UIKitPlus conveniences extend that substrate rather than replacing it; current Apple behavior uses UIKit/AppKit and accepted GTK/Qt/WinUI work follows `architecture/NATIVE_BACKENDS.md`.
